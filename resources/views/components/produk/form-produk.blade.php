                ...
                <form action="{{ $action }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label" for="kategori_produk_id">Kategori Produk</label>
                            <select name="kategori_produk_id" class="form-control" id="kategori_produk_id">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="deskripsi_produk" id="deskripsi_produk" cols="30" rows="5"
                                class="form-control">{{ old('deskripsi_produk', $deskripsi_produk ?? '') }}
                            </textarea>
